...
\begin{table}[htbp]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{lcccccccc}
            \toprule
            \textbf{Sujeito} & \textbf{EEG Total} & \textbf{EEG Válidas} & \textbf{ECG Total} & \textbf{ECG Válidas} & \textbf{EMG Total} & \textbf{EMG Válidas} & \textbf{fNIRS Total} & \textbf{fNIRS Válidas} \\
            \midrule
...
\begin{figure}[htbp]
    ...
    \caption{Razões de potência de banda EEG (alpha/beta, theta/alpha, índice de engajamento, delta/beta, theta/beta) por fase experimental: linha de base, estimulação e recuperação.}
...
\begin{figure}[htbp]
    ...
    \caption{Discriminabilidade de fase (ANOVA $F$-estatística) por atributo e modalidade. Barras vermelhas indicam significância estatística ($p < 0{,}05$).}
...
\begin{figure}[htbp]
    ...
    \caption{Mapa de calor de redundância (correlação de Pearson) entre atributos de EEG. Pares com $|r| \geq 0{,}95$ são considerados redundantes.}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lrrrrrrr}
        \toprule
        \textbf{Modalidade} & \textbf{Obs.} & \textbf{Atrib. entrada} & \textbf{Descartados} & \textbf{PC@90\%} & \textbf{PC@95\%} & \textbf{Var. PC1} & \textbf{Var. PC2} \\
        \midrule
...
\begin{figure}[htbp]
    ...
    \caption{Curva de variância acumulada (EEG). São necessários 26 e 38 componentes para atingir 90\% e 95\% de variância explicada, respectivamente.}
...
\begin{figure}[htbp]
    ...
    \caption{Dispersão PC1 $\times$ PC2 para EEG, colorida por fase experimental (linha de base, estimulação, recuperação). Observa-se sobreposição parcial entre fases, consistente com os resultados de discriminabilidade do Estágio 7.}
...
\begin{figure}[htbp]
    ...
    \caption{Mapa de cargas PCA para EEG: primeiros 5 componentes versus 15 atributos de maior carga absoluta. Os atributos de variação temporal dos poderes espectrais (prefixo \textit{delta2\_}) dominam o PC1.}
