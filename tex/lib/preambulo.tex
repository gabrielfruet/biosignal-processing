...
\usepackage{makecell}                               % Quebra de linha em células de tabela
\usepackage{indentfirst}                            % Endenta o primeiro parágrafo de cada seção.
\usepackage{listings}                               % Utilizar codigo fonte no documento
\usepackage{xcolor}
\usepackage{microtype}                              % Para melhorias de justificação?
\usepackage[portuguese,ruled,lined]{algorithm2e}    % Escrever algoritmos
\usepackage{rotating}                               % Suporte para tabelas em landscape
...
\usepackage{siunitx}         % Usar unidades de medida

\makeglossaries % Organiza e gera a lista de abreviaturas, simbolos e glossario
\makeindex      % Gera o Indice do documento

% Fornece idiomas adicionais para o Babel (necessário para TeX Live 2026+)
% O idioma principal (portuguese/brazil) já é configurado pelo abntex2
\babelprovide{spanish}
